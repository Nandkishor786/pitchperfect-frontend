...
const ServiceCard = ({service,index}) => {
  ...
  return (
    ...
    className='relative overflow-hidden w-full  rounded-xl border border-gray-200 dark:border-gray-200 shadow-2xl shadow-gray-100 dark:shadow-white/10' onMouseEnter={()=>setVisible(true)} onMouseLeave={()=>setVisible(false)} ref={divRef} onMouseMove={handleMouseMove}>
