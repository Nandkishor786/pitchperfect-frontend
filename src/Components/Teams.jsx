...
const Teams = () => {
  return (
    <motion.div
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-36 text-gray-800 dark:text-white"
    >
      <Title
        title="Meet the team"
        ...
        {teamData.map((team, index) => (
          <motion.div
            ...
            className="flex max-sm:flex-col items-center gap-5 p-4 rounded-xl border border-gray-100 dark:border-gray-700 bg-white
                     dark:bg-gray-900 shadow-xl shadow-gray-100 dark:shadow-white/5 hover:scale-105 transition-all duration-400"
          >
